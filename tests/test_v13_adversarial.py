...
Tests parity-clean with tailtest and tailtest-cursor V13 test files.
- read_depth accepts "adversarial" as a valid value
- read_depth still falls back to "standard" on invalid values
- Rule layer file (AGENTS.md) contains R15 text + 8 categories + adversarial depth row
- Hunt slash command file (skills/tailtest/hunt.md) exists with required content
"""
...
HUNT_FILE = os.path.join(REPO_ROOT, "skills", "tailtest", "hunt.md")
...
# ---------------------------------------------------------------------------
# Rule layer (AGENTS.md) contains R15 + categories + adversarial depth row
# ---------------------------------------------------------------------------
