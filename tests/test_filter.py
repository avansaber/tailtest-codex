...
class TestGetTestFilePath:
    PYTHON_RUNNERS: ClassVar[dict] = {
        "python": {"command": "pytest", "args": ["-q"], "test_location": "tests/"}
    }
    TS_RUNNERS: ClassVar[dict] = {
        "typescript": {
            "command": "vitest",
            "args": ["run"],
            "test_location": "__tests__/",
...
class TestDetectFrameworkContext:
    GO_RUNNERS: ClassVar[dict] = {
        "go": {"command": "go test", "args": ["./..."], "style": "colocated"}
    }
    RUST_RUNNERS: ClassVar[dict] = {
        "rust": {"command": "cargo test", "args": [], "style": "inline"}
    }
    LARAVEL_RUNNERS: ClassVar[dict] = {
        "php": {"command": "./vendor/bin/phpunit", "args": [], "framework": "laravel"}
    }
    NEXTJS_RUNNERS: ClassVar[dict] = {
        "typescript": {"command": "vitest", "args": ["run"], "framework": "nextjs"}
    }
    NUXT_RUNNERS: ClassVar[dict] = {
